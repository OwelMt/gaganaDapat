...
function UnityVirtualTwin() {
  return (
    <div style={styles.page}>
      <div style={styles.mobileFrame}>
        <div style={styles.header}>
          <div>
            <h1 style={styles.title}>Virtual Twin</h1>
            <p style={styles.subtitle}>
              Real-time flood simulation for public review
            </p>
          </div>
        ...
        <p style={styles.note}>
          The simulation updates based on the latest flood-monitoring data.
        </p>
      </div>
    </div>
  );
...
export default UnityVirtualTwin;
